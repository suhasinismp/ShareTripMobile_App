...
import { VerifyForgotPasswordOTP } from '../../services/forgotPasswordService';

const OTPVerifyForgotScreen = ({ route }) => {
    ...
    const validateOTP = async () => {
        try {
            ...
            const response = await VerifyForgotPasswordOTP(finalData);

            if (response?.message === 'OTP Matched!') {
                navigation.navigate('ResetPassword', {
                    phoneNumber: phoneNumber,
                    details: details,    // Make sure these values are being passed
                    otp: otp
                });
            } else {
                dispatch(
...
export default OTPVerifyForgotScreen;