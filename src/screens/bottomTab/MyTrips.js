...
import { startTripEndTripScheme } from '../../constants/schema/startTripEndTripScheme';
import {
  closeForDay,
  closeTrip,
  confirmedDriverTrips,
...
//     reset
//   } = useForm({
//     resolver: yupResolver(startTripEndTripScheme)
//   });
//   useEffect(() => {
//     if (showStartTripModal) {
//       const today = new Date();
...
//   const handleCloseTrip = async (formData) => {
//     try {
//       const response = await closeTrip(
//         {
//           post_bookings_id: selectedTripData?.post_booking_id,
//           end_trip_kms: formData.endTripKms,
//           end_trip_date: formData.endDate,
//           end_trip_time: formData.endTime,
//           posted_user_id: selectedTripData?.posted_user_id,
//           accepted_user_id: userId,
//           is_gst: isGstSummaryValue,
//         },
...
//         {
//           post_bookings_id: selectedTripData?.post_booking_id,
//           start_trip_kms: formData.startTripKms,
...
//       <CustomModal
//         visible={showStartTripModal}
//         onPrimaryAction={handleSubmit(handleStartTrip)}
//         onSecondaryAction={() => {
//           setShowStartTripModal(false);
//           reset();
//         }}
